    ...
    public class PersonalBackground extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            submitButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    String lastname = nameLastName.getText().toString();
                    String firstname = nameFirstName.getText().toString();
            ...
            if (requestCode == CAMERA_REQUEST_CODE && resultCode == RESULT_OK) {
                if (data != null && data.getExtras() != null) {
                    ...
                    if (photo != null) {
                        ...
                        String imagePath = saveImg(photo);
                        SharedPreferences preferences = getSharedPreferences("YourSharedPreferencesName", Context.MODE_PRIVATE);
        ...
        private String saveImg(Bitmap bitmap){
            ...
            File path = new File(directory, "photo.jpg");
        ...
        private boolean validateForm() {
            ...
            return !lastname.isEmpty()&& !firstname.isEmpty() && !phone.isEmpty() && !height.isEmpty() && !weight.isEmpty() && !contact.isEmpty();
        }
